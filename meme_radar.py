...
MEME_UP_KEYWORDS = [
    ...
    # 电竞/游戏圈细分梗（KPL梗指南/游戏梗指南/LOL梗指南/瓦罗兰特梗）
    # 2026-08-27 已移除：垂直圈层细分梗（KPL/特定英雄/战队），非大众跨圈层热梗，用户明确不要
    # 体育圈
    "足球梗指南", "NBA梗",
    # 动漫/二次元
    "动漫梗指南", "二次元梗", "新番梗",
...
MEME_UP_MAX_AGE_DAYS = 3       # 梗百科搜索结果最大允许天数（2026-08-27 收紧：与全站 MAX_AGE_DAYS=3 对齐，砍掉解读滞后的旧梗）
SERIES_MAX_AGE_DAYS = 3        # 合集最新一集最大允许天数（同上）
